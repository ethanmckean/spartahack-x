...
while True:
    ...
    # Optionally, you could do zoom and shift transformations here on the full frame
    # For now we work with the full frame.
    ...
    if roi_start_x != -1 and roi_start_y != -1 and roi_end_x != -1 and roi_end_y != -1:
        ...
        # Make sure we have a valid ROI area before processing
    ...
    # You can still use your zoom and translation logic on full_frame if desired.
    # For now, let's resize the full_frame to fit the display window while preserving aspect ratio.
